    ...
    public partial class AddNotificationsEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_erp_notifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_erp_notifications_erp_owners_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_erp_notifications_OwnerId_IsRead_CreatedAt",
